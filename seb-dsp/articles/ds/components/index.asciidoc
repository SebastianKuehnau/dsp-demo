...
[.component-card]
=== Sebtextfield
image::{components-path-prefix}sebtextfield/seb-text-field.png["", opts=inline, role="icon screenshot"]
...
[.component-card]
=== Charts
image::{components-path-prefix}charts/charts.png["", opts=inline, role="icon screenshot"]
...
[.component-card]
=== Map
image::{components-path-prefix}map/map.png["", opts=inline, role="icon screenshot"]
